...
import { synth_01_simple_flow, synth_02_lone_block, synth_03_no_start_pulse, synth_04_no_start_loop, synth_05_multiple_streams_in, synth_06_stepped_loops, synth_07_streaming_loops, synth_08_branching, synth_09_branch_and_join } from './samples/synthetic';
...
describe('FlowGraphAnalysis Compilation E2E', () => {
    ...
    it('should be able to compile branching flows', async () => {
        const CHAT_SVC = "de5baefb-13da-457e-90a5-57a753da8891";
        const WEATHER_SVC = "536bf266-fabf-44a6-ba89-a0c71b8db608";

        are_equivalent_ast(compile(synth_08_branching()), [
            gen_compiled(dsl_to_ast(
                `;PM-DSL ;; Entrypoint for mmm-mode
                (wait-for-monitor from_service: "${TIME_MONITOR_ID}")
                (if (and (= (flow-last-value "source" 0)
    ...
    it('should be able to compile branching-and-joining flows', async () => {
        const CHAT_SVC = "de5baefb-13da-457e-90a5-57a753da8891";
        const WEATHER_SVC = "536bf266-fabf-44a6-ba89-a0c71b8db608";

        const join = compile(synth_09_branch_and_join());

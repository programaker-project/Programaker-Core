...
export function gen_flow(): FlowGraph {
    ...
    const branch6 = builder.add_op('op_wait_seconds', { id: 'branch6',
                                                        args: [ 6 ]
                                                      });
    ...
    const branch4_bot = joiner45.then(f => f.add_op('op_wait_seconds', { id: 'branch4-5_bot',
                                                                         args: [ 4.5 ] }));
    ...
    joiner34.then(f => f.add_op('op_wait_seconds', { id: 'joiner34', args: [ 12 ] }));
                ...
                ((fork
                  ...
                  ((fork
                    ...
                    ((fork ; Branches 4 and 5
                      (op_wait_seconds 4)
                      (op_wait_seconds 5))
                     (op_wait_seconds 4.5))) ; Join 4 and 5
                   ;; Join 3 and 4
                   (op_wait_seconds 12))
                  ;; Branch 6
                  (op_wait_seconds 6))

...
export function gen_flow(): FlowGraph {
    ...
    const joiner = builder.add_trigger('trigger_when_all_completed', {args: [[branch1, 'pulse'], [ if_joiner, 'pulse']]});
...
describe('Flow-21-03: Fork then IF, close merging ALL (correct form).', () => {
